...
export declare type GenericStyleProp<T> = null | void | T | false | '' | readonly GenericStyleProp<T>[];
...
export declare type AnimationStyles = {
    ...
    animationDirection?: (AnimationDirection | AnimationDirection[]) | null | undefined;
    animationDuration?: (string | string[]) | null | undefined;
    animationFillMode?: (AnimationFillMode | AnimationFillMode[]) | null | undefined;
    animationIterationCount?: (AnimationIterationCount | AnimationIterationCount[]) | null | undefined;
    animationKeyframes?: (AnimationKeyframes | AnimationKeyframes[]) | null | undefined;
    animationPlayState?: (AnimationPlayState | AnimationPlayState[]) | null | undefined;
...
export declare type LayoutStyles = {
    ...
    alignItems?: ('baseline' | 'center' | 'flex-end' | 'flex-start' | 'stretch') | null | undefined;
    alignSelf?: ('auto' | 'baseline' | 'center' | 'flex-end' | 'flex-start' | 'stretch') | null | undefined;
    ...
    flexDirection?: ('column' | 'column-reverse' | 'row' | 'row-reverse') | null | undefined;
    ...
    justifyContent?: ('center' | 'flex-end' | 'flex-start' | 'space-around' | 'space-between' | 'space-evenly') | null | undefined;
    ...
    position?: ('absolute' | 'fixed' | 'relative' | 'static' | 'sticky') | null | undefined;
...
export declare type ViewStyle = AnimationStyles & BorderStyles & InteractionStyles & LayoutStyles & ShadowStyles & TransformStyles & {
...
export declare type ViewProps = {
    ...
    style?: false | void | '' | ViewStyle | readonly GenericStyleProp<ViewStyle>[] | null | undefined;
...
export declare type Source = number | string | SourceObject | SourceObject[];
export declare type ImageStyle = AnimationStyles & BorderStyles & InteractionStyles & LayoutStyles & ShadowStyles & TransformStyles & {
...
export declare type ImageProps = ViewProps & {
    ...
    resizeMode?: ResizeMode;
    source: Source;
    style?: false | void | '' | ViewStyle | readonly GenericStyleProp<ImageStyle>[] | null | undefined;
};
...
export declare type TextStyle = ViewStyle & {
    ...
    fontVariant?: readonly ('small-caps' | 'oldstyle-nums' | 'lining-nums' | 'tabular-nums' | 'proportional-nums')[];
...
export declare type TextProps = ViewProps & {
    ...
    onPress?: (e: any) => void;
    selectable?: boolean;
    style?: false | void | '' | ViewStyle | readonly GenericStyleProp<TextStyle>[] | null | undefined;
    testID?: string | null | undefined;
};
export {};
